...
install -Dm644 "deb/${NAME}.conf" "${DEB_SRC}/etc/${NAME}/${NAME}.conf"
install -Dm644 "deb/${NAME}.service" "${DEB_SRC}/lib/systemd/system/${NAME}.service"
install -Dm644 "deb/${NAME}.timer" "${DEB_SRC}/lib/systemd/system/${NAME}.timer"
...
cat LICENSE | sed 's/^/ /g' >> "${DEB_SRC}/usr/share/doc/${NAME}/copyright"
